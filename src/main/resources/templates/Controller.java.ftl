...
public class ${tableName}Controller {
    ...
    @RequestMapping(path = {"/v1/${modelName}${sqlTableName}"}, method = {RequestMethod.POST}, produces = {"application/json"})
    ...
    @RequestMapping(path = {"/v1/${modelName}${sqlTableName}"}, method = {RequestMethod.PUT}, produces = {"application/json"})
...
<#list columnList as fields>
    ...
    public PageVO<${tableName}VO> get${tableName}List(@RequestHeader("tenant_id") String tenantId, @RequestParam("page") int page, @RequestParam("limit") int limit) {
        ...
        List<${tableName}> dataList = ${firstLowerTableName}Service.get${tableName}List(tenantId, offset, limit);
