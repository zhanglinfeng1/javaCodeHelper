...
public class BasePage<T> {
    ...
    private Map<String, List<String>> dataPermissions;//数据拥有的菜单
    ...
    */
    ...
    public int getEndRow(){
        return this.currPageNo*this.limit;
    }
    ...
    public Map<String, List<String>> getDataPermissions() {
        return dataPermissions;
    }

    public void setDataPermissions(Map<String, List<String>> dataPermissions) {
